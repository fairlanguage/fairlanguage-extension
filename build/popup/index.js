...
var STRING_SUPPORTED = 'Diese Website wird unterst&uuml;tzt. <br/> Sollte dennoch ein Fehler auftreten <br/> schreib uns bitte eine Mal.';
var STRING_EXPERIMENTAL = 'Es kann auf dieser Website noch zu<br/>Fehlern kommen.<br/><br/>Daher haben haben wir die Extension <br/>auf dieser Seite zun&auml;chst deaktiviert.<br/><br/>Du kannst sie jedoch troztem<br/>im EXPERIMENTAL STATE aktivieren.';
...
var statusSupportedString = document.getElementById('status-supported-string');
...
statusEnabled.style.display = _config.default.options.settingsEnabled ? 'flex' : 'none';
buttonEnabled.style.display = _config.default.options.settingsEnabled ? 'flex' : 'none';
captionEnabled.style.display = _config.default.options.settingsEnabled ? 'flex' : 'none';
...
stringHost.style.display = _config.default.options.hostSettingsString ? 'flex' : 'none';
captionHost.style.display = _config.default.options.hostSettingsCaption ? 'flex' : 'none';
displayHost.style.display = _config.default.options.hostSettingsDisplay ? 'flex' : 'none';
buttonHostEnable.style.display = _config.default.options.buttonHostEnable ? 'flex' : 'none';
buttonHostDisable.style.display = _config.default.options.buttonHostDisable ? 'flex' : 'none';
...
displayVersion.style.display = _config.default.options.version ? 'flex' : 'none';
var buttonReadMore = document.getElementById('button-read-more');
buttonReadMore.style.display = _config.default.options.buttonReadMore ? 'flex' : 'none';
buttonReadMore.textContent = STRING_READ_MORE;
buttonReadMore.addEventListener('click', function () {
  chrome.tabs.create({
    url: 'https://fairlanguage.com'
  });
});
/**
 * Settings
